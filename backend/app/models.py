...
class LogType(str, enum.Enum):
    ...
    restart_all_triggered = "restart_all_triggered"
    plug_created    = "plug_created"
    plug_updated    = "plug_updated"
    plug_deleted    = "plug_deleted"
    plug_assigned   = "plug_assigned"
    plug_unassigned = "plug_unassigned"
    ...
    tailscale_updated = "tailscale_updated"
    machine_qr_regenerated = "machine_qr_regenerated"
